...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["923130510486", "923130510486"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["923130510486", "923130510486"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["923130510486"];
global.OwnerName = process.env.OWNER_NAME || "Naveed";
global.BotName = process.env.BOT_NAME || "Jani";
